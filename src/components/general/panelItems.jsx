...
const PanelItem = (props) => {
  ...
  return (
    <div>
      <button
        onClick={onClick}
        className={`flex w-full items-center space-x-2 px-3 py-4 bg-yellow-500 border-b-yellow-600 hover:border-b-white transition duration-300 ease-in-out border-b-4 ${
          active ? 'border-b-yellow-700' : ''
        }`}
      >
        <img src={image} alt="" className="h-7 bg-yelow-500" />
